...
<ol>
  ...
  <li>
    Prepare the message schedule $W_j$:
  ...
  <li>
    Initialize eight working variables with the $i-1$ hash value:

    $$
    a = H^{(i-1)}_0,\quad b = H^{(i-1)}_1,\quad c = H^{(i-1)}_2,\quad d = H^{(i-1)}_3
    $$

    $$
    e = H^{(i-1)}_4,\quad f = H^{(i-1)}_5,\quad g = H^{(i-1)}_6,\quad h = H^{(i-1)}_7
    $$
  </li>
  ...
  <li>
    ...
    $$
    T_1 = \big[h + \Sigma_1(e) + \text{Ch}(e,f,g) + K_j + W_j\big] \bmod 2^{32}
    $$

    $$
    T_2 = \big[\Sigma_0(a) + \text{Maj}(a,b,c)\big] \bmod 2^{32}
    $$
